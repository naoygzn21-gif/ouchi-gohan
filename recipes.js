...
var RECIPES_DATA = [
  {
    ...
    "ingredients": [
      ...
      [
        "トッピング(あおさ、マヨネーズ、お好みソース)",
        "お好み"
      ]
    ],
    "steps": [
      "A.キャベツをスライサーですべて千切りにする",
      "B.といたたまごに薄力粉とめんつゆと水を全て入れて混ぜ合わせる",
      "C.AとBを合わせて再度混ぜ合わせる。その際にイカも追加",
      "熱したフライパンに油を引いて、Cを入れる",
      "裏返す前に豚肉を上に置いてひっくり返す",
  ...
  },
  {
    ...
    "desc": "せせりのコリっとした触感と、スナップエンドウのパリッとした触感を一緒に楽しめる！柚子胡椒を使うことで香りよくなってGood！",
    "time": "10分",
    "level": "簡単",
    "tags": [
      "和食",
    ...
    "steps": [
      "スナップエンドウを電子レンジでチンする(食感は残しておきたいので1分くらいでOK)",
      "せせりに塩コショウをまぶす",
      "A.塩こうじと柚子胡椒を混ぜ合わせる",
      "玉ねぎを切る(切り方は好みでOK）",
  ...
  },
  {
    "id": 4,
    "emoji": "🥗",
    "image": "https://drive.google.com/thumbnail?id=1LX3PALNELF-m_MKw9NebOIE0Vuxq8-1V&sz=w800",
    "category": "meal",
    "catLabel": "ごはん",
    "title": "トマトとスナップエンドウの塩昆布おかか和え",
    "desc": "後1皿何か欲しい、、！時にオススメ！",
    "time": "5分",
    "level": "簡単",
    "tags": [
      "作り置き",
  ...
  },
  {
    "id": 5,
    "emoji": "🍽",
    "image": "https://drive.google.com/thumbnail?id=1atj8VHkTXZyeZePuaZS_0AlxNYZInb_a&sz=w800",
    "category": "meal",
    "catLabel": "ごはん",
    "title": "豚バラとピーマンのエスニック風炒め",
    "desc": "ナンプラーとお酢だけでいつもと少し違う炒め物に！",
    "time": "10分",
    "level": "簡単",
    "tags": [
      "エスニック"
    ...
    "steps": [
      "ピーマンを1センチくらいの細切りにする",
      "熱したフライパンにごま油を引いて、豚肉→ピーマンの順に炒める",
      "ピーマンを入れたらナンプラーとお酢を入れて炒める",
      "最後に炒りごまを振ったら完成！"
    ]
  }
];
